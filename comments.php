<div id="comments" id="comments">
    ...
    <?php if (have_comments()): ?>
    		<span class="widget-title"><?php comments_popup_link('暂无评论', '仅有 1 条评论', '已有 % 条评论'); ?></span>
    ...
    <div id="respond" class="respond">
        ...
        <form method="post" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" id="comment-form">
            <div class="col1">
            		<p><textarea rows="8" cols="50" name="text" class="textarea"></textarea></p>
            </div>
            <div class="col2">
				            ...
				            <p>
				                ...
				                <input type="email" name="mail" id="mail" class="text" value="<?php echo $comment_author_email; ?>" />
				            </p>
				            <p>
